 ...
 */
public class RcptPanel extends JPanel {
    ClientFrame frame;
    ...
    private void init() {
        ...
        JLabel title = new JLabel("Reply TMail");
        titPane.add(title);
...
//        this.subject.setEnabled(false);
    ...
    /**
     * init reply panel by outer frame
     *
     * @param frame
     */
    public RcptPanel(ClientFrame frame) {
    ...
    /**
     * reset reply panel by email and reset outer panel
     *
     * @param email
     */
...
//        this.frame.setResizable(false);
        ...
        // clear
        this.to.setText(email.from.split("@")[0]);
        this.subject.setText("Re. " + email.subject);
        ...
        String article = String.format(format, email.from, email.to, email.content);
